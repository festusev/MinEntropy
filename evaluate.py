...
def main(args: argparse.Namespace) -> None:
    ...
    trainer_0 = load_trainer(
        checkpoint_path_0, PPOTrainerCustom,
    ...
    if args.checkpoint_path_1 is not None:
        ...
        trainer_1 = load_trainer(
            checkpoint_path_1, PPOTrainerCustom,
            config_overrides={"input": "sampler", "execution_plan": {"train_extras": []}}
        )
    ...
    if render_path:
        ...
        for agent_index in range(2):
            ...
            ax.imshow(
                np.mean([results["ep_infos"][0][i]["agent_infos"][agent_index]["action_probs"] for i in range(400)],
                        axis=0), cmap="hot")
